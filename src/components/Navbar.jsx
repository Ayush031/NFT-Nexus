    ...
    return (
        <>
            <nav className='w-[100%] flex items-center h-[12%] justify-evenly mt-2  '>
                ...
                <div className='flex basis-1/3 h-12 bg-gray-200 rounded-2xl pt-3 justify-center '> Search </div>
                <div className='flex justify-evenly list-none basis-1/3'>
                    ...
                    <NavLink to="/trade" className="btn btn-outline btn-info" >Trade</NavLink>
