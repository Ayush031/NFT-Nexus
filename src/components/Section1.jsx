...
function Section1() {
  ...
  return (
    <>
      <div className="flex items-center justify-center gap-72 h-[88%] w-full">
        <div>
          <div>
            <p className="font-bold text-transparent text-6xl bg-clip-text text-white">
              <span className="text-8xl font-bold text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-orange-600">
                Discover
              </span>
              <br />
              Collect, and
        ...
        <div className="flex justify-between basis-1/4 ">
          ...
          <div className="text-xl flex flex-col gap-4 mt-5">
            <p className="  text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-orange-600">
              26K+ <br /> <span className="text-white text-sm"> Artwork</span>
            </p>
            <p className="  text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-orange-600">
              18K <br /> <span className="text-white text-sm"> Auction</span>
            </p>
            <p className="  text-transparent  bg-clip-text bg-gradient-to-r from-purple-400 to-orange-600">
              8K <br /> <span className="text-white text-sm"> Artist</span>
            </p>
          </div>
        </div>
      </div>
      <div className="pl-36">
        <div className="flex-col justify-center items-center gap-5 ">
          ...
          <Link
            to="https://finance.yahoo.com/crypto/"
        ...
        <div className="flex justify-start gap-8 mt-8">
          {markets.map((market) => (
            <div className="border rounded-3xl border-cyan-700 list-none text-center p-3 basis-1/6 cursor-pointer">
              {market.Name}
            </div>
          ))}
        </div>
        <div className="flex justify-betweeen mt-10 flex-wrap gap-5">
          {stocks.map((stock, index) => (
            <div
              key={index}
              className="basis-1/5 bg-cyan-50 flex flex-col justify-center text-center items-center gap-5 rounded-3xl  h-60 text-black"
            >
